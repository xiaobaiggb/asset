package com.javaee.lqsx.asset.util;
...
public class ExportExcelUtil<T>{
    ...
    public void mtyExcel(String fileName, String title, String[] headers, Collection<T> dataset, HttpServletResponse response, String version) {
        try {
