...
<div class="x-nav">
      <span class="layui-breadcrumb">
       <a href="">首页</a>
        <a href="<%=path%>/manage/findManage2">资产管理领导查询列表</a>
      </span>
    <a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="<%=path%>/manage/findManage2" title="刷新">
        <i class="layui-icon" style="line-height:30px">&#xe669;</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=path%>/manage/findManage2" >
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            if(res == '202'){
                                ...
                                setTimeout(function () {window.location.href='<%=path%>/manage/findManage2';},2000);
                            }
                        },
                        error:function(){
