...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="#">资产管理系统</a></div>
    <div class="left_open">
        <i title="展开左侧栏" class="iconfont">&#xe699;</i>
    </div>
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">资产管理员：</li>
        <li class="layui-nav-item" style="margin-right: 40px;">
            <a href="javascript:;">${sessionScope.ad.no}</a>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/acquisition/findAcquisition">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产购置</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/assets/findAssets">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产录入</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/assets/findAssets2">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产库存管理</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/recipients/findRecipients">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产领用管理</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/returns/findReturns">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产归还管理</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/statistic/statistic">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产盘点</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/repair/findRepair">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产维修管理</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=path%>/deprecition/findDeprecition">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>资产折旧管理</cite>
                        </a>
                    </li >
